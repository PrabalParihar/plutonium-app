export default function SelectToken() {
    return (
        <div className="col-span-2 sm:col-span-1">
            ...
            >
                <option>SOL</option>
                <option disabled>PLUTO - Coming soon™</option>
                <option disabled>USDC - Coming soon™</option>
                <option disabled>ETH - Coming soon️™</option>
                <option disabled>BTC - Coming soon️™</option>
                <option disabled>FTT - Coming soon️™</option>
                <option disabled>SRM - Coming soon️™</option>
                <option disabled>BNB - Coming soon™</option>
